...
BEGIN
    ...
    WHERE 
        ...
        ISNULL(i.Final_Grade, -1) <> ISNULL(d.Final_Grade, -1)
        OR ISNULL(i.Midterm_Grade, -1) <> ISNULL(d.Midterm_Grade, -1)
        OR ISNULL(i.Quiz_Grade, -1) <> ISNULL(d.Quiz_Grade, -1)
        OR ISNULL(i.Assignment_Grade, -1) <> ISNULL(d.Assignment_Grade, -1)
